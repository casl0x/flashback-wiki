...
import { ExternalLink, Film, Sparkles, User } from "lucide-react";
...
export default function CreateursPage() {
  ...
  return (
    <div className="space-y-6 p-4 lg:p-8">
      {/* Header */}
      <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-5 lg:p-8">
...
function CreatorCard({ creator }: { creator: Creator }) {
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-border bg-card p-4 transition-colors hover:border-accent/30">
